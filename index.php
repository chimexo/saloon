...
<html lang="en">
    ...
    <body <?php if (isset($_SESSION["id"])) {echo "onload='directNavigationBar()'";} ?> >
        <div class="main-container">
            ...
            <div class="columnLeft">
                <img src="../Salon-management-master/Salon-management-master/Barbing_Salon-scaled.jpg" alt="model">
        </div>
            
            <div class="columnRight">
                <img src="images/barbing_Tobivibes.jpg" alt="model">
      </div>
            ...
            <div class="appointment-container">
                <div class='row'>
                    <div class='col-lg-7 col-xs-12 main_column'>
                        <img src='images/maxresdefault.jpg' title='barber'/>
                </div>
    ...
    <footer style="height:50vh;">
        ...
        <div id="lastfooter">
            <p> Copyright &copy; 2021 Style and Smile Salon House All Rights Reserved</p>
        </div>
    </footer>
